...
const Footer = () => {
  return (
    <div>
      <footer className='flex md:flex-row flex-col-reverse items-center justify-between text-left w-full px-8 border'>
        <div className='flex items-center gap-4'>
          ...
          <p className='py-4 text-center text-xs md:text-sm text-gray-500'>Copyright 2026 &copy; SaRas. All Right Reserved</p>
        </div>
